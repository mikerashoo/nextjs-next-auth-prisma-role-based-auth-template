...
import AddCashierToShop from "./AddCashierToshop";

function ShopCashierList() {
  const { cashiers, loading, shopId, error, onDelete, onUpdate, reload } =
    useShopCashiersContext();
        ...
        caption={{
          ...
          extra: (
            <div className="flex justify-between gap-4">
              ...
              <AddCashierToShop shopId={shopId} />
            </div>
          ),
        }}
        loading={loading}
...
export default ShopCashierList;
