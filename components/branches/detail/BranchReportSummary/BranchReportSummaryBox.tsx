...
import FilterByPeriodCombo, { CustomDatePicker } from "@/components/date-filter/FilterByPeriodCombo";
import ChakraRadio from "@/components/ui-components/ChakraRadio";
import { useBranchCashiersContext } from "@/contexts/branch-contexts/BranchCashierContext";
import { useBranchReportContext } from "@/contexts/branch-contexts/BranchReportContext";
...
function BranchReportSummaryBox() {
  const { loading, error, report, currentFilter } = useBranchReportContext();
...
export default BranchReportSummaryBox;
